...
t_data = '/data/zijun/Workspaces/CourseProj_ws/ModernSigProc/medic-img-seg-resunetpp/datasets/after_trans/train/'
l_data = '/data/zijun/Workspaces/CourseProj_ws/ModernSigProc/medic-img-seg-resunetpp/datasets/after_trans/train_label/'
test_image = '/data/zijun/Workspaces/CourseProj_ws/ModernSigProc/medic-img-seg-resunetpp/datasets/after_trans/test/0001.jpg'
test_label = '/data/zijun/Workspaces/CourseProj_ws/ModernSigProc/medic-img-seg-resunetpp/datasets/after_trans/test_label/0001.png'
test_folderP = '/data/zijun/Workspaces/CourseProj_ws/ModernSigProc/medic-img-seg-resunetpp/datasets/after_trans/test/*'
test_folderL = '/data/zijun/Workspaces/CourseProj_ws/ModernSigProc/medic-img-seg-resunetpp/datasets/after_trans/test_label/*'
...
for i in range(epoch):
    ...
    # print(f's_tb.shape: {s_tb.shape}')
    test_tb = s_tb.unsqueeze(0).to(device)    
    pred_tb = model_test(test_tb)
    pred_tb = pred_tb.cpu()
...
#######################################################
print(f'Saving the images in the files ...')
...
####################################################
print(f'Calculating the Dice Score ...')

### (lzj:change 'data_transform' below to 'grayscale_transform')
